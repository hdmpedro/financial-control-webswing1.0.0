 ...
 */const v=window,e1=v.ShadowRoot&&(v.ShadyCSS===void 0||v.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i1=Symbol(),m1=new WeakMap;class w1{constructor(t,a,i){if(this._$cssResult$=!0,i!==i1)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=a}get styleSheet(){let t=this.o;const a=this.t;if(e1&&t===void 0){const i=a!==void 0&&a.length===1;i&&(t=m1.get(a)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&m1.set(a,t))}return t}toString(){return this.cssText}}const D=e=>new w1(typeof e=="string"?e:e+"",void 0,i1),K1=(e,...t)=>{const a=e.length===1?e[0]:t.reduce((i,r,s)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[s+1],e[0]);return new w1(a,e,i1)},q1=(e,t)=>{e1?e.adoptedStyleSheets=t.map(a=>a instanceof CSSStyleSheet?a:a.styleSheet):t.forEach(a=>{const i=document.createElement("style"),r=v.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=a.cssText,e.appendChild(i)})},N1=e1?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let a="";for(const i of t.cssRules)a+=i.cssText;return D(a)})(e):e;/**
 * @license
...
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),z1=/'/g,b1=/"/g,v1=/^(?:script|style|textarea|title)$/i,f1=e=>(t,...a)=>({_$litType$:e,strings:t,values:a}),c=f1(1),e2=f1(2),C=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),C1=new WeakMap,Y=Z.createTreeWalker(Z,129,null,!1),S1=(e,t)=>{const a=e.length-1,i=[];let r,s=t===2?"<svg>":"",n=B;for(let l=0;l<a;l++){const d=e[l];let j,h,M=-1,g=0;for(;g<d.length&&(n.lastIndex=g,h=n.exec(d),h!==null);)g=n.lastIndex,n===B?h[1]==="!--"?n=T1:h[1]!==void 0?n=A1:h[2]!==void 0?(v1.test(h[2])&&(r=RegExp("</"+h[2],"g")),n=f):h[3]!==void 0&&(n=f):n===f?h[0]===">"?(n=r!=null?r:B,M=-1):h[1]===void 0?M=-2:(M=n.lastIndex-h[2].length,j=h[1],n=h[3]===void 0?f:h[3]==='"'?b1:z1):n===b1||n===z1?n=f:n===T1||n===A1?n=B:(n=f,r=void 0);const m=n===f&&e[l+1].startsWith("/>")?" ":"";s+=n===B?d+a2:M>=0?(i.push(j),d.slice(0,M)+"$lit$"+d.slice(M)+A+m):d+A+(M===-2?(i.push(void 0),l):m)}const p=s+(e[a]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[j1!==void 0?j1.createHTML(p):p,i]};class W{constructor({strings:t,_$litType$:a},i){let r;this.parts=[];let s=0,n=0;const p=t.length-1,l=this.parts,[d,j]=S1(t,a);if(this.el=W.createElement(d,i),Y.currentNode=this.el.content,a===2){const h=this.el.content,M=h.firstChild;M.remove(),h.append(...M.childNodes)}for(;(r=Y.nextNode())!==null&&l.length<p;){if(r.nodeType===1){if(r.hasAttributes()){const h=[];for(const M of r.getAttributeNames())if(M.endsWith("$lit$")||M.startsWith(A)){const g=j[n++];if(h.push(M),g!==void 0){const m=r.getAttribute(g.toLowerCase()+"$lit$").split(A),y=/([.?@])?(.*)/.exec(g);l.push({type:1,index:s,name:y[2],strings:m,ctor:y[1]==="."?O1:y[1]==="?"?k1:y[1]==="@"?Q1:R})}else l.push({type:6,index:s})}for(const M of h)r.removeAttribute(M)}if(v1.test(r.tagName)){const h=r.textContent.split(A),M=h.length-1;if(M>0){r.textContent=U?U.emptyScript:"";for(let g=0;g<M;g++)r.append(h[g],_()),Y.nextNode(),l.push({type:2,index:++s});r.append(h[M],_())}}}else if(r.nodeType===8)if(r.data===d1)l.push({type:2,index:s});else{let h=-1;for(;(h=r.data.indexOf(A,h+1))!==-1;)l.push({type:7,index:s}),h+=A.length-1}s++}}static createElement(t,a){const i=Z.createElement("template");return i.innerHTML=t,i}}function S(e,t,a=e,i){var r,s,n,p;if(t===C)return t;let l=i!==void 0?(r=a._$Co)===null||r===void 0?void 0:r[i]:a._$Cl;const d=G(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((s=l==null?void 0:l._$AO)===null||s===void 0||s.call(l,!1),d===void 0?l=void 0:(l=new d(e),l._$AT(e,a,i)),i!==void 0?((n=(p=a)._$Co)!==null&&n!==void 0?n:p._$Co=[])[i]=l:a._$Cl=l),l!==void 0&&(t=S(e,l._$AS(e,t.values),l,i)),t}class E1{constructor(t,a){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=a}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var a;const{el:{content:i},parts:r}=this._$AD,s=((a=t==null?void 0:t.creationScope)!==null&&a!==void 0?a:Z).importNode(i,!0);Y.currentNode=s;let n=Y.nextNode(),p=0,l=0,d=r[0];for(;d!==void 0;){if(p===d.index){let j;d.type===2?j=new $(n,n.nextSibling,this,t):d.type===1?j=new d.ctor(n,d.name,d.strings,this,t):d.type===6&&(j=new U1(n,this,t)),this.u.push(j),d=r[++l]}p!==(d==null?void 0:d.index)&&(n=Y.nextNode(),p++)}return s}p(t){let a=0;for(const i of this.u)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,a),a+=i.strings.length-2):i._$AI(t[a])),a++}}class ${constructor(t,a,i,r){var s;this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=t,this._$AB=a,this._$AM=i,this.options=r,this._$Cm=(s=r==null?void 0:r.isConnected)===null||s===void 0||s}get _$AU(){var t,a;return(a=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&a!==void 0?a:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const a=this._$AM;return a!==void 0&&t.nodeType===11&&(t=a.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,a=this){t=S(this,t,a),G(t)?t===N||t==null||t===""?(this._$AH!==N&&this._$AR(),this._$AH=N):t!==this._$AH&&t!==C&&this.g(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):L1(t)?this.k(t):this.g(t)}O(t,a=this._$AB){return this._$AA.parentNode.insertBefore(t,a)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==N&&G(this._$AH)?this._$AA.nextSibling.data=t:this.T(Z.createTextNode(t)),this._$AH=t}$(t){var a;const{values:i,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=W.createElement(r.h,this.options)),r);if(((a=this._$AH)===null||a===void 0?void 0:a._$AD)===s)this._$AH.p(i);else{const n=new E1(s,this),p=n.v(this.options);n.p(i),this.T(p),this._$AH=n}}_$AC(t){let a=C1.get(t.strings);return a===void 0&&C1.set(t.strings,a=new W(t)),a}k(t){I1(this._$AH)||(this._$AH=[],this._$AR());const a=this._$AH;let i,r=0;for(const s of t)r===a.length?a.push(i=new $(this.O(_()),this.O(_()),this,this.options)):i=a[r],i._$AI(s),r++;r<a.length&&(this._$AR(i&&i._$AB.nextSibling,r),a.length=r)}_$AR(t=this._$AA.nextSibling,a){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,a);t&&t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var a;this._$AM===void 0&&(this._$Cm=t,(a=this._$AP)===null||a===void 0||a.call(this,t))}}class R{constructor(t,a,i,r,s){this.type=1,this._$AH=N,this._$AN=void 0,this.element=t,this.name=a,this._$AM=r,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=N}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,a=this,i,r){const s=this.strings;let n=!1;if(s===void 0)t=S(this,t,a,0),n=!G(t)||t!==this._$AH&&t!==C,n&&(this._$AH=t);else{const p=t;let l,d;for(t=s[0],l=0;l<s.length-1;l++)d=S(this,p[i+l],a,l),d===C&&(d=this._$AH[l]),n||(n=!G(d)||d!==this._$AH[l]),d===N?t=N:t!==N&&(t+=(d!=null?d:"")+s[l+1]),this._$AH[l]=d}n&&!r&&this.j(t)}j(t){t===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t!=null?t:"")}}class O1 extends R{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===N?void 0:t}}const i2=U?U.emptyScript:"";class k1 extends R{constructor(){super(...arguments),this.type=4}j(t){t&&t!==N?this.element.setAttribute(this.name,i2):this.element.removeAttribute(this.name)}}class Q1 extends R{constructor(t,a,i,r,s){super(t,a,i,r,s),this.type=5}_$AI(t,a=this){var i;if((t=(i=S(this,t,a,0))!==null&&i!==void 0?i:N)===C)return;const r=this._$AH,s=t===N&&r!==N||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,n=t!==N&&(r===N||s);s&&this.element.removeEventListener(this.name,this,r),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var a,i;typeof this._$AH=="function"?this._$AH.call((i=(a=this.options)===null||a===void 0?void 0:a.host)!==null&&i!==void 0?i:this.element,t):this._$AH.handleEvent(t)}}class U1{constructor(t,a,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=a,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){S(this,t)}}const r2={P:"$lit$",A,M:d1,C:1,L:S1,R:E1,D:L1,V:S,I:$,H:R,N:k1,U:Q1,B:O1,F:U1},Z1=q.litHtmlPolyfillSupport;Z1==null||Z1(W,$),((o1=q.litHtmlVersions)!==null&&o1!==void 0?o1:q.litHtmlVersions=[]).push("2.6.1");const s2=(e,t,a)=>{var i,r;const s=(i=a==null?void 0:a.renderBefore)!==null&&i!==void 0?i:t;let n=s._$litPart$;if(n===void 0){const p=(r=a==null?void 0:a.renderBefore)!==null&&r!==void 0?r:null;s._$litPart$=n=new $(t.insertBefore(_(),p),p,void 0,a!=null?a:{})}return n._$AI(e),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var M2=Object.defineProperty,p2=Object.getOwnPropertyDescriptor,$1=(e,t,a,i)=>{for(var r=i>1?void 0:i?p2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&M2(t,a,r),r};o.WsToast=class extends I{constructor(){super(),this._toastText=""}render(){return c`
    ...
    `}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-live","polite")}show(e="",t=3e3){return new Promise((a,i)=>{this.className==="show"||(t>=1e3&&(this.style.animation=`fadein 0.5s, fadeout 0.5s ${t-500}ms`),this._toastText=e,this.className="show",setTimeout(()=>{this._toastText="",this.style.animation="",this.className=this.className.replace("show",""),a()},t>=1e3?t:3e3))})}},o.WsToast.styles=[D(z),D(l2)],$1([u()],o.WsToast.prototype,"_toastText",2),o.WsToast=$1([T("ws-toast")],o.WsToast);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*P1(e,t){if(e!==void 0){let a=0;for(const i of e)yield t(i,a++)}}const h2=()=>{const e=/stage(\w+)/mg,t=window.location.pathname.match(e);return t&&t.length>0?t[0]:""},w=(...e)=>e.filter(Boolean).join(" "),_1=(e,t)=>Math.floor(e+Math.random()*(t-e+1)),c2=e=>new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(e);var g2=Object.defineProperty,u2=Object.getOwnPropertyDescriptor,J=(e,t,a,i)=>{for(var r=i>1?void 0:i?u2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&g2(t,a,r),r};o.WsDetailForm=class extends I{constructor(){super(),this.readonly=!1,this.data={id:_1(300,1e3),name:"",category:"",awardYear:"",prizeAmount:"",status:"",country:"",link:""}}handleInput(e){let{id:t,value:a}=e.target;this.data[t]=a;const i=new CustomEvent("form-changed",{detail:{...this.data},composed:!1,cancelable:!0,bubbles:!1});this.dispatchEvent(i)}getKeyName(e){switch(e){case"id":return"ID";case"name":return"Name";case"category":return"Category";case"awardYear":return"Award year";case"prizeAmount":return"Prize amount";case"status":return"Status";case"country":return"Country";case"link":return"Link"}return""}render(){return this.readonly?c`
                        ...
                        ${Object.entries(this.data).map(([e,t])=>c`
                                    <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                            ${e==="prizeAmount"&&t?c2(t):e==="link"&&t?c`
...
`;var w2=Object.defineProperty,N2=Object.getOwnPropertyDescriptor,P=(e,t,a,i)=>{for(var r=i>1?void 0:i?N2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&w2(t,a,r),r};o.WsModal=class extends I{constructor(){super(...arguments),this.header="",this.okButtonText="Confirm",this.cancelButtonText="Cancel",this.content="",this.show=!1}_close(e){this.dispatchEvent(new CustomEvent("close",{detail:e}))}open(){this.show=!0}handleClick(){this.show=!1,this._close("ok")}closeModal(e){this.show=!1,this._close(e)}render(){return c`
    ${this.show?c`
        ...
        `:""}
      `}},o.WsModal.styles=[D(z),D(m2)],P([u()],o.WsModal.prototype,"header",2),P([u()],o.WsModal.prototype,"okButtonText",2),P([u()],o.WsModal.prototype,"cancelButtonText",2),P([u()],o.WsModal.prototype,"content",2),P([u()],o.WsModal.prototype,"show",2),o.WsModal=P([T("ws-modal")],o.WsModal);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const y2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},D2=e=>(...t)=>({_$litDirective$:e,values:t});class x2{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,a,i){this._$Ct=t,this._$AM=a,this._$Ci=i}_$AS(t,a){return this.update(t,a)}update(t,a){return this.render(...a)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:j2}=r2,G1=()=>document.createComment(""),F=(e,t,a)=>{var i;const r=e._$AA.parentNode,s=t===void 0?e._$AB:t._$AA;if(a===void 0){const n=r.insertBefore(G1(),s),p=r.insertBefore(G1(),s);a=new j2(n,p,e,e.options)}else{const n=a._$AB.nextSibling,p=a._$AM,l=p!==e;if(l){let d;(i=a._$AQ)===null||i===void 0||i.call(a,e),a._$AM=e,a._$AP!==void 0&&(d=e._$AU)!==p._$AU&&a._$AP(d)}if(n!==s||l){let d=a._$AA;for(;d!==n;){const j=d.nextSibling;r.insertBefore(d,s),d=j}}}return a},E=(e,t,a=e)=>(e._$AI(t,a),e),I2={},L2=(e,t=I2)=>e._$AH=t,T2=e=>e._$AH,h1=e=>{var t;(t=e._$AP)===null||t===void 0||t.call(e,!1,!0);let a=e._$AA;const i=e._$AB.nextSibling;for(;a!==i;){const r=a.nextSibling;a.remove(),a=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B1=(e,t,a)=>{const i=new Map;for(let r=t;r<=a;r++)i.set(e[r],r);return i},A2=D2(class extends x2{constructor(e){if(super(e),e.type!==y2.CHILD)throw Error("repeat() can only be used in text expressions")}ht(e,t,a){let i;a===void 0?a=t:t!==void 0&&(i=t);const r=[],s=[];let n=0;for(const p of e)r[n]=i?i(p,n):n,s[n]=a(p,n),n++;return{values:s,keys:r}}render(e,t,a){return this.ht(e,t,a).values}update(e,[t,a,i]){var r;const s=T2(e),{values:n,keys:p}=this.ht(t,a,i);if(!Array.isArray(s))return this.ut=p,n;const l=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],d=[];let j,h,M=0,g=s.length-1,m=0,y=n.length-1;for(;M<=g&&m<=y;)if(s[M]===null)M++;else if(s[g]===null)g--;else if(l[M]===p[m])d[m]=E(s[M],n[m]),M++,m++;else if(l[g]===p[y])d[y]=E(s[g],n[y]),g--,y--;else if(l[M]===p[y])d[y]=E(s[M],n[y]),F(e,d[y+1],s[M]),M++,y--;else if(l[g]===p[m])d[m]=E(s[g],n[m]),F(e,s[M],s[g]),g--,m++;else if(j===void 0&&(j=B1(p,m,y),h=B1(l,M,g)),j.has(l[M]))if(j.has(l[g])){const b=h.get(p[m]),u1=b!==void 0?s[b]:null;if(u1===null){const X1=F(e,s[M]);E(X1,n[m]),d[m]=X1}else d[m]=E(u1,n[m]),F(e,s[M],u1),s[b]=null;m++}else h1(s[g]),g--;else h1(s[M]),M++;for(;m<=y;){const b=F(e,d[y+1]);E(b,n[m]),d[m++]=b}for(;M<=g;){const b=s[M++];b!==null&&h1(b)}return this.ut=p,L2(e,d),C}}),z2=`:host{min-height:0;display:flex;flex-direction:column}
`;var b2=Object.defineProperty,v2=Object.getOwnPropertyDescriptor,O=(e,t,a,i)=>{for(var r=i>1?void 0:i?v2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&b2(t,a,r),r};o.WsTable=class extends I{constructor(){super(...arguments),this.search="",this.headers=[],this.data=[],this.sortColumn="",this.sortDirection=""}handleSearch(e){this.search=e.target.value}handleSort(e){this.sortDirection||(this.sortDirection="desc"),this.sortDirection=this.sortDirection==="asc"?"desc":"asc",this.sortColumn=e}_view(e){this.dispatchEvent(new CustomEvent("viewRow",{detail:e}))}_edit(e){this.dispatchEvent(new CustomEvent("editRow",{detail:e}))}_delete(e){this.dispatchEvent(new CustomEvent("deleteRow",{detail:e}))}_select(e){this.dispatchEvent(new CustomEvent("selectRow",{detail:e}))}render(){const e=!this.sortColumn||!this.sortDirection?this.data:this.data.sort((i,r)=>{const s=this.sortColumn==="award year"?"awardYear":this.sortColumn;return this.sortDirection==="asc"?i[s]>r[s]?1:-1:i[s]<r[s]?1:-1}),t=this.search?e==null?void 0:e.filter(i=>{var r,s;return((r=i.name)==null?void 0:r.toLowerCase().includes(this.search.toLocaleLowerCase()))||((s=i.country)==null?void 0:s.toLowerCase().includes(this.search.toLocaleLowerCase()))}):e,a=i=>{let r="ml-1 ";const s=i.toLowerCase();return this.sortColumn===s?(r+="bg-gray-200 text-gray-900 group-hover:bg-gray-300 flex-none rounded ",r+=this.sortDirection==="desc"?"rotate-0":"rotate-180"):r+="invisible text-gray-400 group-hover:visible group-focus:visible",r};return c`
    ...
    `}},o.WsIntro.styles=[D(z)],t1([u()],o.WsIntro.prototype,"introTitle",2),t1([u()],o.WsIntro.prototype,"introDesc",2),t1([u()],o.WsIntro.prototype,"introButton",2),o.WsIntro=t1([T("ws-intro")],o.WsIntro);const S2=`:host,slot{display:flex;flex-direction:column;height:100%}:host(.migration){background-color:#dff6ff;border:1px solid #00a0db}
`;var E2=Object.defineProperty,O2=Object.getOwnPropertyDescriptor,V=(e,t,a,i)=>{for(var r=i>1?void 0:i?O2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&E2(t,a,r),r};o.WsTabs=class extends I{constructor(){super()}get tabs(){const e=this.shadowRoot.querySelector("slot");return e?e.assignedElements():[]}removeTab(e,t){t.stopPropagation();const a=this.shadowRoot.querySelector("slot");(a?a.assignedElements():[]).forEach(r=>{r.label===e.label&&r.remove()}),this.selectTab(this.tabs[1]),this.requestUpdate()}firstUpdated(){this.tabs.find(e=>e.selected)||this.selectTab(this.tabs[0])}render(){return c`
    ...
    `}selectTab(e){for(let t of this.tabs)t.selected=t==e;this.requestUpdate()}},o.WsTabs.styles=[D(z),D(S2)],o.WsTabs=V([T("ws-tabs")],o.WsTabs),o.WsTab=class extends I{constructor(){super(...arguments),this.closable=!1}render(){return c`
...
`;var R2=Object.defineProperty,H2=Object.getOwnPropertyDescriptor,k=(e,t,a,i)=>{for(var r=i>1?void 0:i?H2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&R2(t,a,r),r};o.WsLayout=class extends I{constructor(){super(...arguments),this.pageTitle="",this.bCenter=!1,this.pageDesc="",this.pageIcon="1",this.toggleSidebar=!1,this.toggleMobileNav=!1,this.getServerUrl=()=>{const e=window.location.href;return e.substring(0,e.indexOf("/migration-examples"))+"/migration-examples"}}toggle(){this.toggleSidebar=!this.toggleSidebar}toggleMobile(){this.toggleMobileNav=!this.toggleMobileNav,this.toggleSidebar&&(this.toggleSidebar=!1)}getImage(e){switch(e){case"1":return Z2;case"2":return Y2;case"3":return $2;case"4":return P2}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResize.bind(this)),this.onResize()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize.bind(this))}onResize(){window.innerWidth<=767&&!this.toggleMobileNav?this.toggleMobileNav=!0:window.innerWidth>767&&this.toggleMobileNav&&(this.toggleMobileNav=!1),window.innerWidth<=1120&&!this.toggleSidebar?this.toggleSidebar=!0:window.innerWidth>1120&&this.toggleSidebar&&(this.toggleSidebar=!1)}render(){return c`
          ...
          <div class="flex-1 flex flex-col min-h-0 bg-secondary">
            <div class="flex items-center flex-shrink-0 p-4 justify-between">
              <a href="${this.getServerUrl()}">
                <img class="h-10 w-auto" src=${this.toggleSidebar?U2:Q2} />
              </a>
    ...
    `}},o.WsLayout.styles=[D(z),D(k2)],k([u()],o.WsLayout.prototype,"pageTitle",2),k([u()],o.WsLayout.prototype,"bCenter",2),k([u()],o.WsLayout.prototype,"pageDesc",2),k([u()],o.WsLayout.prototype,"pageIcon",2),k([H()],o.WsLayout.prototype,"toggleSidebar",2),k([H()],o.WsLayout.prototype,"toggleMobileNav",2),o.WsLayout=k([T("ws-layout")],o.WsLayout);const J2=`svg path:hover{fill:#78d0f7}:host{min-height:50%}
`;var F2=Object.defineProperty,V2=Object.getOwnPropertyDescriptor,g1=(e,t,a,i)=>{for(var r=i>1?void 0:i?V2(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&F2(t,a,r),r};o.WsMap=class extends I{constructor(){super(),this.active="",this.addEventListener("click",e=>{const t=e.composedPath()[0],a=t.getAttribute("data-name");t&&t.localName==="path"&&a&&(this.active=a)})}updated(e){var t;e.has("active")&&(this.paths.forEach(a=>a.classList.remove("fill-primary")),(t=this.shadowRoot.querySelectorAll(`svg path[data-name="${this.active}"]`))==null||t.forEach(a=>a.classList.add("fill-primary")))}render(){return c`
    ...
    `}},o.WsMap.styles=[D(z),D(J2)],g1([u({reflect:!0})],o.WsMap.prototype,"active",2),g1([d2("svg path")],o.WsMap.prototype,"paths",2),o.WsMap=g1([T("ws-map")],o.WsMap);const X2=e2`
...
`,K2=`:host{display:flex;flex-direction:column;height:100%;padding:1rem;box-sizing:border-box;overflow:auto}
`;var q2=Object.defineProperty,t5=Object.getOwnPropertyDescriptor,a5=(e,t,a,i)=>{for(var r=i>1?void 0:i?t5(t,a):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(r=(i?n(t,a,r):n(r))||r);return i&&r&&q2(t,a,r),r};o.WsHome=class extends I{constructor(){super(...arguments),this.getServerUrl=()=>{const e=window.location.href;return e.substring(0,e.indexOf("/migration-examples"))+"/migration-examples"}}render(){return c`
      <div class="container mx-auto">
        <div class="bg-white rounded-md shadow-md">
          <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
    ...
    `}},o.WsHome.styles=[D(z),D(K2)],o.WsHome=a5([T("ws-home")],o.WsHome),Object.defineProperties(o,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
